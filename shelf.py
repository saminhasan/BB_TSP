...
# Example of using the Shelf class
if __name__ == "__main__":
    # Create some products to place on the shelf
    ...
    # Create a shelf and add products to it
    shelf_example = Shelf("1A", 5.0, 5.0, 10.0, 4.0, [product1, product2])
    print(shelf_example)
